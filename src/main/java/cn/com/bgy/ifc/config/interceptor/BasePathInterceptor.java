...
public class BasePathInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            throws Exception {
        String []  allowDomain= {"http://192.168.0.200:8080","http://192.168.0.101:8081","http://192.168.0.104:8080","http://192.168.0.103:8080","http://47.99.100.79:8080","http://127.0.0.1:8080","http://www.tgiant.cn:8080","http://www.tgiant.com:8080"};
