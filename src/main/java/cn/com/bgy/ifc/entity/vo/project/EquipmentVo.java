 ...
 * @Description 第三方接口调用--》设备信息VO
 **/

public class EquipmentVo extends  BgyBaseVo{
    //设备名
    private String name;
    //设备详情
    ...
    public String toString() {
        return "EquipmentVo{" + "name='" + name + '\'' + ", description='" + description + '\'' + ", inputCode='" + inputCode + '\'' + ", machineRoomId=" + machineRoomId + ", versionId=" + versionId + ", brandId=" + brandId + ", typeId=" + typeId + ", keepYears=" + keepYears + ", inWorkTime='" + inWorkTime + '\'' + ", isImportant=" + isImportant + ", status=" + status + ", simpleCode='" + simpleCode + '\'' + ", apiCode='" + apiCode + '\'' + '}';
    }
}
