...
public class FireInspectionController extends BaseController{
     ...
     */
    @PostMapping("add")
    @SystemLogAfterSave(type = 1,description = "消防巡检主表单新增")
    @ResponseBody
    ...
    @SystemLogAfterSave(type = 1,description = "消防巡检主表单修改")
    @ResponseBody
    ...
    @ResponseBody
    public ResponseVO<FireInspection> queryById(@PathVariable long id, String token) {
     ...
     */
    @PostMapping("delete")
    @SystemLogAfterSave(type = 1,description = "消防巡检主表单删除")
    @ResponseBody
